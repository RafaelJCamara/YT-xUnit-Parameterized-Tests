...
public class MyLibraryClassClassDataTest
{
    [Theory]
    [ClassData(typeof(TotalSumClassData))]
    public void ClassDataTest_TotalSum(int el1, int el2, int el3, int totalSumExpected)
    {
        //Arrange
